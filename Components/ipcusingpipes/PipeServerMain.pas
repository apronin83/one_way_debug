...
procedure TPipeServerForm.PipeServer1PipeConnect(Sender: TObject; Pipe: HPIPE);
begin
  Memo1.Lines.Add('Client connected ' + IntToStr(Pipe));
end;

procedure TPipeServerForm.PipeServer1PipeDisconnect(Sender: TObject; Pipe: HPIPE);
begin
  Memo1.Lines.Add('Client disconnected ' + IntToStr(Pipe));
end;

procedure TPipeServerForm.PipeServer1PipeMessage(Sender: TObject; Pipe: HPIPE; Stream: TStream);
var
  Msg: String;
begin
