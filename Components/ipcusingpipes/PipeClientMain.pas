...
type
  TPipeClientForm = class(TForm)
    ...
    procedure PipeClient1PipeDisconnect(Sender: TObject; Pipe: HPIPE);
  private
...
procedure TPipeClientForm.PipeClient1PipeMessage(Sender: TObject; Pipe: HPIPE; Stream: TStream);
var
  Msg: String;
begin
...
begin
  ...
  if not PipeClient1.Connected then ConnectPipe;
